...
import { useEstimateFare, useCreateBooking, useGetBooking } from "@workspace/api-client-react";
    ...
    if (pickup.length > 3 && destination.length > 3) {
      ...
      debounceRef.current = setTimeout(() => {
        estimateFareMutation.mutate(
          { data: { pickupLocation: pickup, destination } },
          {
                  ...
                  <div className="space-y-4 pl-10">
                    <div className="space-y-1">
                      ...
                      <Input 
                        ...
                        className="h-12 border-0 bg-slate-50 focus-visible:ring-1 focus-visible:bg-white transition-colors"
                      />
                    </div>
                    <div className="space-y-1">
