...
import { useGetDriverDashboard, useToggleDriverOnline, useUpdateBookingStatus, useAcceptBooking } from "@workspace/api-client-react";
...
export default function DriverDashboard() {
  ...
  const handleAccept = (bookingId: number) => {
    acceptBooking.mutate(
      { id: bookingId, data: { driverId: 0, estimatedArrival: new Date(Date.now() + 10 * 60000).toISOString() } },
      {
        onSuccess: () => {
